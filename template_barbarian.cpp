...
int acc(int amr, char arw){
	...
	if (arw == 'h'){return amr;}
	return 10+amod(dex)+amod(con);
}
//Armor
int amr = 10;
//Armor Weight ([L]ight, [M]edium, [H]eavy,[U]narmored)
int arw = 'u';
//Armor Class
int arc = acc(amr, arw);
//Spell Slots
...
//Chose two (Animal Handling, Athletics, Intimidation, Nature, Perception, Survival)
//Skill Prof List
void spro(){
	cout << "Skills: ";
}
...
void prof(){
	...
	cout << "\n\t";
	cout << "Weapons: Simple Weapons, Martial Weapons";
	cout << "\n\t";
	cout << "Tools: N/A";
	cout << "\n\t";
	cout << "Saving Throws: Strength, Constitution";
	cout << "\n\t";
	spro();
	cout << "\n\t";
	cout << "Languages: " << endl;
